...
public class PrestamoController {
    ...
    @PostMapping
    public ResponseEntity<Respuesta<Prestamo>> save(@RequestBody PrestamoPostDTO prestamoDTO){
    ...
    public ResponseEntity<Respuesta<List<Prestamo>>> findByCodigoCliente(@PathVariable String codigoCliente){
        return ResponseEntity.status(HttpStatus.OK).body(new Respuesta<>("OK", prestamoServicio.findByCodigoCliente(codigoCliente)));
    }

    @GetMapping("/fecha/{fecha}")
    public ResponseEntity<Respuesta<List<Prestamo>>> findByDate(@PathVariable LocalDate fecha){
        return ResponseEntity.status(HttpStatus.OK).body(new Respuesta<>("OK", prestamoServicio.findByDate(fecha)));
    }
    ...
    public ResponseEntity<Respuesta<Prestamo>> findById(@PathVariable long codigoPrestamo){
        return ResponseEntity.status(HttpStatus.OK).body(new Respuesta<>("OK", prestamoServicio.findById(codigoPrestamo)));
    }
    ...
    public ResponseEntity<Respuesta<Prestamo>> update(@PathVariable long codigoPrestamo, @RequestBody PrestamoPostDTO prestamoPostDTO){
